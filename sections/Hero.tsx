  ...
  return (
    <section className="w-full bg-white py-32 text-charcoal">
      <div className="mx-auto flex w-full max-w-7xl flex-col items-center gap-10 px-6 text-center md:px-12">
        <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }} className="space-y-4 max-w-6xl">
        ...
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.6, delay: 0.08 }} className="w-full max-w-6xl px-4 md:px-0">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: 0.12 }} className="w-full max-w-5xl px-6 md:px-0">
          <p className="text-base font-display leading-relaxed text-smoke">
            “Clients hire me when they need a single point of accountability—someone who understands the stakes, simplifies the room, and moves the
